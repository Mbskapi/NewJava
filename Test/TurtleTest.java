...
//}
//
//    // TODO: 9/2/2022  move forward facing all three directions
//    @Test
//    public void turtleCanWriteWhenPenIsDownTest() {
////         ijapa.penDown();
////         assertEquals(new postion(row:0, column:0), ijapa.getCurrentDirection());
////         assertfalse(ijapa.isPenUp());
////        SketchPad sketchPad = new SketchPad(noOfRows:5, noOfColumn:5);
////         ijapa.move(noOfSteps:3, SketchPad);
////
////     }
//
////}
